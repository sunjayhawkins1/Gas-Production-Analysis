...
ui <- dashboardPage(
  ...
  dashboardBody(
    ...
    tabItem(tabName = "simple", 
            radioGroupButtons(inputId = "selected_model",
    ...
    tabItem(tabName = "smooth", radioGroupButtons(inputId = "selected_ETS",
                                             label = "Select your model",
...
),   tabItem(tabName = "arima", radioGroupButtons(inputId = "selected_param",
